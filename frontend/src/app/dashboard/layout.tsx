            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-semibold transition-all ${
                  isActive
                    ? "bg-gradient-to-r from-indigo-500/10 to-transparent text-indigo-400 border-l-2 border-indigo-500 font-bold"
        ...
        <div className="fixed inset-0 z-50 flex md:hidden bg-slate-950/80 backdrop-blur-sm">
          <div className="relative flex w-full max-w-xs flex-col bg-slate-900 p-6 border-r border-slate-850">
            ...
            <div className="flex items-center gap-3 pb-6 border-b border-slate-850 mb-6">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-tr from-emerald-500 to-indigo-600 text-white">
                <Landmark className="h-4 w-4" />
              </div>
              <span className="font-bold text-slate-100">Antigravity LMS</span>
            </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between border-b border-slate-900 bg-slate-900/30 px-6 backdrop-blur-md md:hidden">
          <div className="flex items-center gap-3">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-tr from-emerald-500 to-indigo-600 text-white">
              <Landmark className="h-4 w-4" />
            </div>
